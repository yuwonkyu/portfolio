...
const Header = ({
  ...
  navItems = [
    ...
    { id: "featured-work", label: "주요 프로젝트", href: "#featured-work" },
    { id: "personal-projects", label: "개인 · 앱", href: "#personal-projects" },
    { id: "study-works", label: "팀 프로젝트", href: "#study-works" },
    { id: "collaboration", label: "협업 스토리", href: "#collaboration" },
