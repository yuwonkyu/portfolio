...
export const featuredProjects: FeaturedProject[] = [
  {
    ...
    summary:
<<<<<<< HEAD
      "링크형 소개 페이지에 예약 현황 확인 기능을 결합한 서비스입니다. 고객이 예약 가능 여부를 직접 확인할 수 있게 해 DM 문의를 줄이고, 관리자는 적은 조작으로 예약을 등록하고 공유할 수 있도록 설계했습니다.",
=======
...
<<<<<<< HEAD
      "고객 문의를 줄이는 것이 핵심 목적이었기 때문에 예약 안내, 위치 확인, 인스타그램 이동, 예약 가능 여부 확인이 자연스럽게 이어지도록 정보 구조를 정리했습니다.",
...
<<<<<<< HEAD
    highlights: ["운영 효율 개선", "관리자 UX 설계", "공유 캘린더 구조"],
=======
>>>>>>> 12cabbc283c0e6e6f6d54fe214b2b376af59c11f
    technologies: [
      "Next.js",
  ...
  },
  {
    ...
    highlights: ["5일 내 제작", "클라이언트 협업", "유지보수 구조화"],
    technologies: [
      "Next.js 16",
      "App Router",
      "TypeScript",
...
>>>>>>> 12cabbc283c0e6e6f6d54fe214b2b376af59c11f
    ...
    collaboration: [
<<<<<<< HEAD
      "개인 수익화를 목표로 한 제품 성격이 강했기 때문에, 단일 사이트가 아니라 여러 고객에게 반복 제공 가능한 구조로 설계했습니다.",
=======
...
>>>>>>> 12cabbc283c0e6e6f6d54fe214b2b376af59c11f
  ...
  },
  {
    ...
    description:
<<<<<<< HEAD
      "심화 프로젝트에서는 React Hook Form, Zod, Zustand 같은 기술을 실제 서비스에 어떻게 적용할지 팀 내에서 합의하는 과정이 쉽지 않았습니다. 멘토링과 토론을 반복하며 선택 기준을 정리하려 했고, 이후 상태 관리를 다시 다듬으며 판단 기준의 중요성을 더 크게 느꼈습니다.",
=======
