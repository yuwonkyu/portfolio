...
export const featuredProjects: FeaturedProject[] = [
  ...
  },
  {
    ...
    title: "윤슬이집",
    period: "2026",
    team: "예약 랜딩 페이지 · 관리자 기능 1인 개발",
    role: "예약 안내 페이지, 관리자 예약 관리 화면, 데이터 저장 구조까지 프론트엔드 전반 설계 및 구현",
    summary:
      "소개 페이지에 예약 현황 확인 기능을 결합한 실운영 서비스입니다. 고객이 예약 가능 여부를 직접 확인할 수 있어 DM 문의를 줄이고, 관리자는 최소한의 조작으로 예약을 등록·공유할 수 있습니다.",
    description: [
      "예약 안내·위치 확인·인스타그램·문의 동선을 한 화면에 정리해 고객이 필요한 정보를 빠르게 찾을 수 있도록 구성했습니다.",
      "관리자는 예약 가능/대기/완료 세 가지 상태를 캘린더에 등록하고, 고객은 공유 링크로 예약 상황을 즉시 확인할 수 있습니다.",
      "반복적인 DM 문의를 줄이고 운영자가 빠르게 예약 상태를 관리할 수 있는 운영 효율 개선이 핵심 과제였습니다.",
    ],
    contribution: [
      "관리자 전용 페이지와 예약 관리 UX 설계",
      "2중 비밀번호 인증 + 추측 불가 슬러그 라우팅으로 보안 처리",
      "캘린더 기반 예약 슬롯 등록 및 상태 관리 구현",
      "예약 건수에 따른 날짜 색상 시각화 로직 구현",
      "토스트 알림을 통한 즉각적 피드백 설계",
      "Upstash Redis를 활용한 예약 데이터 저장·공유 구조 적용",
    ],
    collaboration: [
      "운영자가 최소한의 조작으로 빠르게 예약을 등록할 수 있도록 복잡한 입력 대신 빠른 등록 흐름과 즉각적인 피드백에 집중했습니다.",
      "고객 문의 감소가 핵심 목적이어서 예약 안내·위치·인스타·예약 가능 여부 확인이 자연스럽게 이어지도록 정보 구조를 정리했습니다.",
      "제주도의 시원하고 맑은 인상을 전달하기 위해 배경색 #f3efe8을 중심으로 첫 방문 경험을 설계했습니다.",
    ],
    outcomes: [
      "관리자가 저장한 예약 일정을 고객과 공유 가능한 형태로 운영할 수 있어 반복적인 DM 응대를 줄이는 구조를 완성했습니다.",
  ...
  },
  {
    ...
    period: "2026",
    team: "클라이언트 의뢰 · 5일 납품",
    role: "클라이언트 커뮤니케이션, 랜딩 페이지 구현, 포트폴리오 구조 설계, 유지보수 가능한 코드 구조 담당",
    summary:
      "클라이언트의 브랜딩과 포트폴리오 영상을 효과적으로 보여주는 사이트입니다. 5일 납기 안에 맞춤 제작하면서도 이후 유지보수와 확장을 고려한 구조로 설계했습니다.",
    description: [
      "클라이언트의 인트로 영상과 포트폴리오 영상을 자연스럽게 연결하는 랜딩 경험이 필요했고, 짧은 제작 기간 안에서 현실적인 구현 방법을 선택해야 했습니다.",
      "초기에는 GIF·하드코딩 기반 모션을 직접 구현하려 했지만, 로고 모션 종료 시점과 홈 UI 동기화 요구사항을 만족시키기 어려웠습니다.",
      "단기 납기와 유지보수 가능성을 동시에 만족하는 구조를 만드는 것이 가장 중요한 과제였습니다.",
    ],
    contribution: [
      "Next.js App Router 기반 사이트 구조 설계",
      "최초 1회 재생되는 MP4 인트로 영상 흐름 구현",
      "유튜브 임베드 기반 포트폴리오 영상 구조 설계",
      "연도별 영상 분류로 탐색성과 성능 동시 최적화",
      "사이드바 내비게이션을 통한 페이지 이동 UX 개선",
      "FSD 구조 적용으로 유지보수성·인수인계 편의성 확보",
    ],
    collaboration: [
      "5일 납기 동안 클라이언트와 지속적으로 작업 내용을 공유하며 우선순위를 빠르게 조율했습니다.",
      "직접 구현한 모션 방식을 고집하기보다, 클라이언트가 원하는 완성도와 일정 기준으로 MP4 방식으로 전환했습니다.",
      "GitHub 비공식 저장소로 관리 후 클라이언트가 포크해 후속 개발자가 포크 싱크와 커밋 수정으로 유지보수할 수 있게 구조를 열어두었습니다.",
    ],
    outcomes: [
      "브랜딩 소개 페이지이면서도 포트폴리오 영상을 안정적으로 공유할 수 있는 사이트를 빠른 일정 안에 완성했습니다.",
...
export const personalProjects: CompactProject[] = [
  {
    ...
    category: "개인 앱 프로젝트",
    summary:
      "오늘 뭐 먹을지 고민될 때 슬라임 캐릭터가 랜덤으로 음식을 골라주는 Android 앱입니다. Google Play 비공개 테스터로 배포 중입니다.",
    description: [
      "카테고리 필터(한식·중식·일식·양식·분식·디저트)와 혼밥/단체 모드를 지원하며, 뽑기 히스토리로 오늘 먹은 메뉴는 자동 제외됩니다.",
      "슬라임 캐릭터가 음식별 아이템을 착용하고 등장하는 컬렉션 도감 시스템을 설계해 재방문 유인 구조를 만들었습니다.",
    ],
    technologies: [
      "React Native",
      "Expo",
    ...
    collaborationNote:
      "Claude API와 협업해 기획부터 개발까지 1인으로 진행했으며, Google Play 베타 테스트·스토어 심사 준비 등 앱 출시 프로세스를 직접 경험했습니다.",
    learningNote:
      "웹과 다른 모바일 특유의 애니메이션, 스크린 전환, 네이티브 API 연동 감각을 익혔습니다.",
    githubUrl: "https://github.com/yuwonkyu/random-nyamnyam",
    imageUrl: "/images/random-nyamnyam.jpg",
    imageAlt: "랜덤냠냠 앱 화면",
  },
  {
    id: "template-gallery",
...
export const collaborationHighlights: CollaborationStory[] = [
  ...
  },
  {
    ...
    description:
      "초급 프로젝트에서 팀 분위기가 흔들리는 상황에서 각자의 의견과 감정을 풀어 설명하고, 답답해하는 마음을 들어주며 중간에서 조율하려 노력했습니다. 개발 외의 커뮤니케이션도 프로젝트 완수에 큰 영향을 준다는 점을 체감했습니다.",
  },
  {
    title: "팀장 경험을 통해 배운 결단과 책임",
    description:
      "세 번째 팀에서 팀장을 맡아 코어타임 지각과 작업 지연 문제를 직접 다뤘습니다. 맡은 범위를 조정하고 최소 기능을 재배분하며 프로젝트를 수습하려 했고, 배포 실패까지 겪으며 리더는 공감뿐 아니라 결단도 필요하다는 점을 배웠습니다.",
  },
  {
    title: "기술 선택의 모호함을 정리하는 협업 방식",
    description:
      "심화 프로젝트에서 React Hook Form, Zod, Zustand 같은 기술을 실제 서비스에 어떻게 적용할지 팀 내에서 합의하는 과정이 쉽지 않았습니다. 멘토링과 토론을 반복하며 선택 기준을 정리했고, 이후 상태 관리를 다시 다듬으며 판단 기준의 중요성을 더 크게 느꼈습니다.",
  },
  {
    title: "프로젝트가 끝난 뒤에도 이어지는 협업 네트워크",
    description:
      "부트캠프 기간 동안 프로젝트가 끝날 때마다 디스코드 서버를 직접 만들어 동기들과 공유했고, 최종적으로는 기수 전체가 모일 수 있는 서버까지 운영했습니다. 필요한 정보와 취업 관련 자료를 꾸준히 공유하며 관계를 일회성 협업으로 끝내지 않으려 했습니다.",
  },
];

export const coreStrengths = [
  "웹 서비스 납품 · 앱 스토어 출시까지 제품 전체 사이클을 경험했습니다.",
  "React · Next.js · React Native로 목적에 맞는 구조를 설계합니다.",
  "클라이언트 커뮤니케이션부터 팀장 경험까지 다양한 협업 환경에 적응합니다.",
];
